...
|-------------------------------------------------------|---------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Xcode 13.2.1                                          | [Xcode_13.2.1.xip][]                  | *c:*`xcode`<br>(And latest SDKs)                                                                                  |
...
[//]: # (Download links)
[Xcode_13.2.1.xip]: https://download.developer.apple.com/Developer_Tools/Xcode_13.2.1/Xcode_13.2.1.xip
